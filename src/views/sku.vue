    ...
    <div class="goodsDetailcotainer">
        <div class="card">
            <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
                <van-swipe-item v-for="(item,index) in imgs" :key="item.src" @click="fetchLunboimg(index)"><img
                        src="https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fp3.itc.cn%2Fimages01%2F20211005%2F4b88d16427634e3b92947f7b7614c01e.jpeg&refer=http%3A%2F%2Fp3.itc.cn&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1666150091&t=772696e26fc978a8c41c5e9e699128bc"
                        alt=""></van-swipe-item>
            </van-swipe>
        </div>
        <div class="card">
        ...
        <div>
            <van-goods-action>
                ...
                <van-goods-action-icon icon="cart-o" text="购物车" :badge="$store.getters.getscreeningcarnumber"
                    to="/home/shopcar" />
